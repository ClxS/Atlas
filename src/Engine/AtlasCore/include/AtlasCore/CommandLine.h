...
#define DEFINE_COMMAND_ARG_SL_DEFAULT(NAME, TYPE, SWITCH_SHORT, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, SWITCH_SHORT, {}, DESCRIPTION, false, DEFAULT)
#define DEFINE_COMMAND_ARG_S_DEFAULT(NAME, TYPE, SWITCH_SHORT, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, SWITCH_SHORT, {}, DESCRIPTION, false, DEFAULT)
#define DEFINE_COMMAND_ARG_L_DEFAULT(NAME, TYPE, SWITCH_LONG, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, {}, SWITCH_LONG, DESCRIPTION, false, DEFAULT)
#define DEFINE_REQUIRED_COMMAND_ARG_SL_DEFAULT(NAME, TYPE, SWITCH_SHORT, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, SWITCH_SHORT, {}, DESCRIPTION, true, DEFAULT)
#define DEFINE_REQUIRED_COMMAND_ARG_S_DEFAULT(NAME, TYPE, SWITCH_SHORT, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, SWITCH_SHORT, {}, DESCRIPTION, true, DEFAULT)
#define DEFINE_REQUIRED_COMMAND_ARG_L_DEFAULT(NAME, TYPE, SWITCH_LONG, DESCRIPTION, DEFAULT) DEFINE_COMMAND_ARG_SLEXT(NAME, TYPE, {}, SWITCH_LONG, DESCRIPTION, true, DEFAULT)
